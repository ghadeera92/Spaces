...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { link: @weather.link, zip_code: @weather.zip_code } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { link: @weather.link, zip_code: @weather.zip_code } }
